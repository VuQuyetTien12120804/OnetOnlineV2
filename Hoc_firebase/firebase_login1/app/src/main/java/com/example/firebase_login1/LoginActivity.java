package com.example.firebase_login1;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Intent intent = new Intent(LoginActivity.this, com.example.firebase_login1.HomeActivity.class);
        ...
        txtForgerPass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(LoginActivity.this, com.example.firebase_login1.ForgotPassActivity.class);
                startActivity(in);
            }
        });
    }
